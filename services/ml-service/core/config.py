...
class MLSettings(BaseSettings):
    ...
    SUPPORTED_SPECIES: List[str] = [
        "Bangus", "Tilapia", "Catfish", "Salmon", "Grass_Carp",
        "Big_Head_Carp", "Silver_Carp", "Indian_Carp", "Pangasius",
        "Gourami", "Snakehead", "Climbing_Perch", "Janitor_Fish",
        "Knifefish", "Freshwater_Eel", "Glass_Perchlet", "Goby",
        "Tenpounder", "Black_Spotted_Barb", "Fourfinger_Threadfin",
        "Green_Spotted_Puffer", "Indo_Pacific_Tarpon", "Jaguar_Gapote",
        "Long_Snouted_Pipefish", "Mosquito_Fish", "Mudfish", "Mullet",
        "Perch", "Scat_Fish", "Silver_Barb", "Silver_Perch"
    ]
